...
namespace CSharpPerformancePlaybook.Benchmarker
{
    public class StringFuntions
    {
        ...
        {
            var x = new StringWorker().NaiveSplitName("Josvany, García");
        }

        [Benchmark()]
        public void SplitSplit()
        {
            var x = new StringWorker().SplitSplitName("Josvany, García");
        }

        [Benchmark()]
        public void SpanSplit()
        {
            var x = new StringWorker().SpanSplitName("Josvany, García");
        }
    }
}
